...
import ru.bprn.printhouse.data.repository.OneSheetDigitalPrintingFlowRepository;

import java.util.List;

@Service
public class OneSheetDigitalPrintingFlowService {

    private final OneSheetDigitalPrintingFlowRepository workFlowRepository;
    private final StringBuilder strVariables = new StringBuilder();


    public OneSheetDigitalPrintingFlowService(OneSheetDigitalPrintingFlowRepository workFlowRepository){
        this.workFlowRepository = workFlowRepository;
    }

    public List<OneSheetDigitalPrintingFlow> findAll() {return this.workFlowRepository.findAll();}

    public OneSheetDigitalPrintingFlow save(OneSheetDigitalPrintingFlow workFlow) {return this.workFlowRepository.save(workFlow);}

    public void delete (OneSheetDigitalPrintingFlow workFlow) {this.workFlowRepository.delete(workFlow);}
/*
    public void calcWorkflowParameters(OneSheetDigitalPrintingFlow workFlow) {
        String orient = "";
    ...
    private int getExtraLeaves(OneSheetDigitalPrintingFlow workFlow) {
    ...
    private double getOperationPrice(OneSheetDigitalPrintingFlow workFlow) {
        double total = 0;
        String expression ;
    ...
    private void fillVariables(OneSheetDigitalPrintingFlow workFlow) {
        strVariables
